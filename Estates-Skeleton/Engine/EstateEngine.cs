namespace Estates.Engine
{
    ...
    internal class EstateEngine : IEstateEngine
    {
        private readonly HashSet<string> uniqueEstateNames = new HashSet<string>();
        ...
        public virtual string ExecuteCommand(string cmdName, string[] cmdArgs)
        {
            ...
            {
                case "create":
                    return this.ExecuteCreateCommand(cmdArgs);
                case "status":
        ...
        {
            var offers =
                this.Offers.Where(o => o.Estate.Location == location && o.Type == OfferType.Sale)
        ...
        protected string FormatQueryResults(IEnumerable<IOffer> offers)
        {
            ...
            else
            {
                ...
                foreach (var offer in offers)
                {
                    ...
                    result.AppendFormat("  [Estate: {0}, Location: {1}", offer.Estate.Name, offer.Estate.Location);
                    if (price != null)
                    {
